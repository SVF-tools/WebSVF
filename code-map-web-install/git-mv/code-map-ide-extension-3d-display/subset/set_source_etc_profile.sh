...
if [ "$USER" = 'root' ]; then
	...
	echo 'export LLVM_SRC=$HOME/project/llvm-7.0.0.src' |tee -a $ETC_PROFILE
	echo 'export LLVM_OBJ=$HOME/project/llvm-7.0.0.obj' |tee -a $ETC_PROFILE
	echo 'export LLVM_DIR=$HOME/project/llvm-7.0.0.obj' |tee -a $ETC_PROFILE
	...
	echo 'export LLVM_SRC=$HOME/project/llvm-7.0.0.src' |sudo tee -a $ETC_PROFILE
	echo 'export LLVM_OBJ=$HOME/project/llvm-7.0.0.obj' |sudo tee -a $ETC_PROFILE
	echo 'export LLVM_DIR=$HOME/project/llvm-7.0.0.obj' |sudo tee -a $ETC_PROFILE
