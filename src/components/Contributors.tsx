...
export const Contributors: React.FC<IContributorsProps> = ({
  ...
  const mapDevelopers = () => {
    return developers.map((developer) => (
      <div key={developer.name} className="col-xl-3 col-lg-4 col-md-6 d-flex justify-content-center">
  ...
  const mapSupervisors = () => {
    return supervisors.map((supervisor) => (
      <div key={supervisor.name} className="col-xl-3 col-lg-4 col-md-6 d-flex justify-content-center">
        <div className="testimonial-item mx-auto mb-5 mb-xl-4 text-center">
