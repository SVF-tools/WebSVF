...
**1. Download extension: [VSIX file and TEST zip](https://github.com/SVF-tools/WebSVF/releases/tag/0.0.1)**
  ...
  <img src='https://github.com/codemapweb/codemap_extension/blob/master/images/DOWNLOAD_VISX.png?raw=true' width='720'/>

VSIX file is vscdoe extension. TEST zip for extension testing.

**2. Extension installation**

  <img src='https://github.com/codemapweb/codemap_extension/blob/master/images/VSIX_installation.png?raw=true' width='720'/>
...
**3. Installed situation**
  ...
  <img src='https://github.com/codemapweb/codemap_extension/blob/master/images/after_install.png?raw=true' width='720'/>
...
<img src='https://github.com/codemapweb/codemap_extension/blob/master/images/require.png?raw=true' width='480'/>
...
<img src="https://github.com/codemapweb/codemap_extension/blob/master/images/project.gif?raw=true" width='720'>
...
<img src="https://github.com/codemapweb/codemap_extension/blob/master/images/red.png?raw=true" width='480'>

After a while time to wait all function load. if always loading, you can cancel it by **`[X]`** close the page.

<img src="https://github.com/codemapweb/codemap_extension/blob/master/images/load.png?raw=true" width='480'>

It will show the red block when all function stopped or show blue block when code map running.

<img src="https://github.com/codemapweb/codemap_extension/blob/master/images/blue.png?raw=true" width='480'>

After click to make it work, it will show like this.

<img src="https://github.com/codemapweb/codemap_extension/blob/master/images/show.png?raw=true" width='720'>
...
<img src="https://github.com/codemapweb/codemap_extension/blob/master/images/1.gif?raw=true" width='720'>

**2. Show node label**

Hover over any node will show the label.

<img src="https://github.com/codemapweb/codemap_extension/blob/master/images/2.gif?raw=true" width='720'>

**3. Jump to line**

Right Click node will jump to the code line.

<img src="https://github.com/codemapweb/codemap_extension/blob/master/images/3.gif?raw=true" width='720'>
...
<img src="https://github.com/codemapweb/codemap_extension/blob/master/images/4.gif?raw=true" width='720'>
...
<img src="https://github.com/codemapweb/codemap_extension/blob/master/images/5.gif?raw=true" width='720'>
...
<img src="https://github.com/codemapweb/codemap_extension/blob/master/images/6.gif?raw=true" width='720'>
...
<img src="https://github.com/codemapweb/codemap_extension/blob/master/images/7.gif?raw=true" width='720'>
