...
const constants = {
    ...
    node_branch: path.sep + 'WebSVF-bug-report-fe', //Node app branch name
    ...
    download_uri: 'https://github.com/SVF-tools/WebSVF/releases/download/0.1.0/WebSVF-bug-report-fe.zip' //Download the bug_report analysis tool as a zip from remote github
}
