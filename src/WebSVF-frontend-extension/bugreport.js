...
module.exports = function(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('extension.bugreport', function () {
        let file_path = constants.workspace + '/'+constants.node_app + constants.node_branch + constants.config_abspath; //workspace/.bug-report/WebSVF-WebSVF-frontend-server/config/bug-analysis-JSON_absolute-dir.config
