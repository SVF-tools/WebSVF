...
const gen_filesHTML = () => {
    //Storing no. of files (elements) in the json file report in 'bugreportjson_length'
    const bugreportjson_length = Object.keys(bugreportjson.bugreport).length;
    ...
    for(var i = 0; i<bugreportjson_length; ++i){
        ...
        $('#files-analysed #v-pills-tab').append(`${make_pillTab(i,fileName,bugreportjson_length)}`);

        $('#files-analysed #v-pills-tabContent').append(`${make_pill(i,fileName,bugreportjson_length)}`);
